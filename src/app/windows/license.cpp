...
#define LICENSE_GPL_V3_LOGO ":/images/licenses/gpl-v3-logo"
#define LICENSE_GPL_V3_TEXT ":/text/licenses/gpl-3.0-markdown"
...
void License::initUi() {
    ...
    QByteArray data = readFile(LICENSE_GPL_V3_LOGO);
    QPixmap pixmap;
    ...
    data = readFile(LICENSE_GPL_V3_TEXT);
